...
function createTaskEl(taskDataObj) {
    ...
    let taskActionsEl = createTaskActions(taskIdCounter, taskDataObj.status);
...
// Create task actions
function createTaskActions(taskId, status) {
